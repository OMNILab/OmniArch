...
def test_basic_connection():
    ...
    if not api_key or not api_base:
        ...
        print("export OPENAI_API_BASE='https://dashscope.aliyuncs.com/compatible-mode/v1'")
        return None
...
def main():
    ...
    models_to_test = ["qwen3-235b-a22b", "qwen3-30b-a3b", "qwen3-32b", "qwen-turbo-2025-04-28", "qwen-plus-2025-04-28"]
